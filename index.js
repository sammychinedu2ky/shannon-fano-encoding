...
function reduceStages(stages,length){
    let newStages = []
...
function shanon(word){
    ...
    while(shouldContinue){
       ...
       stages.push(stage);
       if(stage.length==2)shouldContinue=false
        start++
    }
  stages.forEach(i=>{
...
let reducedStages = reduceStages(stages,lengthOfCharacters)
